...
int RunTests(); 
void CorrectNumberOfRootsPrint(int supposed_count_of_roots, // TODO: verb usually goes first in names, try to come up with a better name
                                    double a, double b, double c, // TODO: indentation?
                                    double supposed_x1, double supposed_x2,
                                    double true_x1, double true_x2,
                                    int count);
void IncorrectNumberOfRootsPrint(int true_count, int false_count); // TODO: better name
